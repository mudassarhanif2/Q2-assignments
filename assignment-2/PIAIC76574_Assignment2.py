...
def function6():
    ...
    arr = np.zeros(10, dtype=int); arr[4] = 10; arr[7]=20  #wrtie your code here
...
def function7():
    ...
    return np.full_like(x, 0) #write your code here
...
def function8():
    ...
    x = np.full((2,5), 6, dtype='u4')  #write your code here
...
def function10():
    ...
    brr = np.array([1,2,3])
    subt = arr - brr[:,np.newaxis] # write your code here 
...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = np.hstack((np.full_like(arr, 1),np.full_like(arr, 2),np.full_like(arr, 3),arr,arr,arr)) #write your code here 
...
def function17():
    ...
    return np.where(arr%3 | arr%5 == 0, 'YES', 'NO')  # Write Your Code HERE
...
def function18():
    ...
    x = np.count_nonzero(np.isin(students, piaic) == True) # Write you code Here
    return x
